                        ...
                        <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
                            ...
                            >
                                <input
                                    ...
                                    placeholder="Search"
                                    aria-label="Search"
                                    className="col-start-1 focus-none focus:border-none  border-none row-start-1 block size-full bg-white pl-8 text-base text-gray-900 outline-none placeholder:text-gray-400 sm:text-sm/6"
                                />
                                <MagnifyingGlassIcon
                                    aria-hidden="true"
